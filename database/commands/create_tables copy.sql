...
CREATE TABLE IF NOT EXISTS peoples (
                    ...
                    name               VARCHAR(255)     NOT NULL, -- name_en
                    date_of_birth      DATE,
                    ...
                    address            VARCHAR(255)    NULL, -- address_en
                    permanent_address  VARCHAR(255),
                    father_or_spouse   VARCHAR(255),
                    father_name        VARCHAR(255)    NULL, -- father_en
                    mother_name        VARCHAR(255)    NULL, -- mother_en
                    class              VARCHAR(100),
                    phone              VARCHAR(20)     NOT NULL,
...
CREATE TABLE IF NOT EXISTS routines (
                ...
                subject      VARCHAR(255)           NOT NULL, -- subject_en
                name         VARCHAR(255)           NOT NULL, -- name_en
...
CREATE TABLE IF NOT EXISTS events (
                ...
                title        VARCHAR(255)  NOT NULL, -- title_en
