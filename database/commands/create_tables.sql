...
CREATE TABLE IF NOT EXISTS transactions (
                ...
                type           VARCHAR(50)  NOT NULL CHECK (type IN ('fees','donations','others')),
                month          VARCHAR(50),
...
CREATE TABLE IF NOT EXISTS peoples (
                    ...
                    birth_certificate_hash  VARCHAR(255) NOT NULL,
                    ...
                    present_address_hash  VARCHAR(255) NOT NULL,
                    present_address_encrypted VARCHAR(255) NOT NULL,
                    address            VARCHAR(255)    NULL,
                    address_hash  VARCHAR(255) NOT NULL,
                    address_encrypted VARCHAR(255) NOT NULL,
                    permanent_address  VARCHAR(255),
                    permanent_address_hash  VARCHAR(255) NOT NULL,
                    permanent_address_encrypted VARCHAR(255) NOT NULL,
                    ...
                    is_special_member   BOOLEAN         DEFAULT 0,
                    is_special_member2  BOOLEAN         DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS logs (
                ...
                trace_info_hash  VARCHAR(255) NOT NULL,
                trace_info_encrypted VARCHAR(255) NOT NULL,
                level      VARCHAR(50)  NOT NULL CHECK (level IN ('info','warning','error','critical')) DEFAULT 'info',
