...
('English',               'ইংরেজি',        'الإنجليزية',                          'nurani1'),
('Word Book',             'ওয়ার্ড বুক',     'كتاب الكلمات',                       'nurani1'),
('Active English',        'একটিভ ইংলিশ',   'الإنجليزية العملية',                 'nurani1'),
('Rhymes',                'রাইমস',          'الأناشيد',                            'nurani1'),
('Mathematics',           'গণিত',          'الرياضيات',                          'nurani1'),
...
('English',               'ইংলিশ',         'الإنجليزية',                          'nurani2'),
('Word Book',             'ওয়ার্ড বুক',     'كتاب الكلمات',                       'nurani2'),
('Active English',        'একটিভ ইংলিশ',   'الإنجليزية العملية',                 'nurani2'),
('Rhymes',                'রাইমস',          'الأناشيد',                            'nurani2'),
...
('English Grammar',       'ইংলিশ গ্রামার', 'قواعد الإنجليزية',                   'nurani3'),
('Active English',        'একটিভ ইংলিশ',   'الإنجليزية العملية',                 'nurani3'),
('Handwriting',           'হাতের লেখা',     'خط اليد',                            'nurani3'),
...
('At-Tamrinul Kitabi & Bangla/Grammar','আততামরীনুল কিতাবী ও বাংলা + ব্যাকরণ','تمارين كتابية والبنغالية/النحو','madani_nesab'),
('Aso English Shikhi',            'এসো ইংরেজি শিখি',                  'تعلم الإنجليزية',                  'madani_nesab'),
('English & Grammar',             'ইংলিশ এন্ড গ্রামর',                 'الإنجليزية والنحو',                'madani_nesab'),
('Primary Mathematics',           'প্রাথমিক গণিত',                      'رياضيات ابتدائية',               'madani_nesab'),
...
INSERT INTO people (
  ...
  gender, degree, acc_type, title1
) VALUES
(1,  'Abu Ahmad Abdur Rob',       'আবু আহমাদ আব্দুর রব',       'أبو أحمد عبد الرب',
     'Dudh Mia',                  'দুধ মিয়া',                  'دود ميا',
     '+8801931164900',
     'Mirpur, Dhaka',             'মিরপুর, ঢাকা',             'ميربور، دكا',
     'Male', 'Mawlana', 'teachers', 'Director & Shaykh al-Hadith'),

(4,  'Tazul Islam Madani',        'তাজুল ইসলাম মাদানী',        'تاج الإسلام المدني',
     'Abu Ahmad Abdur Rob',        'আবু আহমাদ আব্দুর রব',       'أبو أحمد عبد الرب',
     '+8801916290927',
     'Mirpur, Dhaka',             'মিরপুর, ঢাকা',             'ميربور، دكا',
     'Male', 'Mawlana', 'teachers', 'Acting Director'),

(5,  'Nurul Islam Qasemi',        'নূরুল ইসলাম কাসেমী',        'نور الإسلام قاسمي',
     'Abu Ahmad Abdur Rob',        'আবু আহমাদ আব্দুর রব',       'أبو أحمد عبد الرب',
     '+447877474580',
     'Mirpur, Dhaka',             'মিরপুর, ঢাকা',             'ميربور، دكا',
     'Male', 'Mawlana', 'teachers', 'Senior Deputy Director'),

(6,  'Sultan Mahmudur Rahman',    'সুলতান মাহমুদুর রহমান',     'سلطان محمود الرحمن',
     'Fakhruddin Ahmad',           'ফখরুদ্দীন আহমাদ',          'فخر الدين أحمد',
     '+8801911216026',
     'Demra, Dhaka',              'ডেমরা, ঢাকা',              'دمرا، دكا',
     'Male', 'Mawlana', 'teachers', 'Deputy Director & Education Secretary'),

(7,  'K M Shafiul Islam Albazi',  'কে এম শফিউল ইসলাম আলবাজী','ك. م. شفيع الإسلام البازعي',
     'Md. Jabed Ali',             'মোঃ জাবেদ আলী',            'محمد جابد علي',
     '+8801733269998',
     'Mirpur, Dhaka',             'মিরপুর, ঢাকা',             'ميربور، دكا',
     'Male', 'Mawlana', 'teachers', 'Assistant Deputy Director'),

(8,  'Sakhawat Hossain Qasemi',   'সাখাওয়াত হোসাইন কাসেমী',    'سخاوات حسين قاسمي',
     'Abu Yusuf',                  'আবু ইউসুফ',                'أبو يوسف',
     '+8801974068812',
     'Kachua, Chandpur',          'কচুয়া, চাঁদপুর',           'كاشيا، تشاندپور',
     'Male', 'Mawlana', 'teachers', 'Assistant Deputy Director'),

(9,  'Saeedul Islam',             'সাঈদুল ইসলাম',             'سعيد الإسلام',
     'Md. Gias Uddin',             'মোঃ গিয়াস উদ্দিন',        'محمد قياس الدين',
     '+8801925817472',
     'Ishwarganj, Mymensingh',    'ঈশ্বরগঞ্জ, ময়মনসিংহ',     'إيشوارغانج، ميمينسين',
     'Male', 'Mawlana', 'teachers', 'Assistant Education Secretary'),


(11, 'Ibrahim Hossain',           'ইবরাহীম হোসাইন',          'إبراهيم حسين',
     'Md. Akbar Ali Sheikh',      'মোঃ আকবর আলী শেখ',        'محمد أكبر علي الشيخ',
     '+8801987199291',
     'Raiganj, Sirajganj',        'রায়গঞ্জ, সিরাজগঞ্জ',      'رايجانج، سيراججانج',
     'Male', 'Mawlana', 'teachers', 'Assistant Housing Secretary'),


(13, 'Najmus Sakib',              'নাজমুস সাকিব',             'نجموس صكيب',
     'Md. Harun-or-Rashid',       'মোঃ হারুন-অর-রশিদ',       'محمد هارون الرشيد',
     '+8801918111253',
     'Pallabi, Dhaka',            'পল্লবী, ঢাকা',             'پالبی، دكا',
     'Male', 'Mawlana', 'teachers', 'Senior Muhaddith'),


(15, 'Zaheerul Islam Nadvi',      'যহীরুল ইসলাম নদভী',       'زهير الإسلام الناذوي',
     'Yusuf',                     'ইউসুফ',                    'يوسف',
     '+8801883248093',
     'Sonaimuri, Noakhali',       'সোনাইমুড়ী, নোয়াখালী',     'سوناي موري، نواآخالي',
     'Male', 'Mawlana', 'teachers', 'Senior Muhaddith'),

(16, 'Khalid Saifullah',          'খালিদ সাইফুল্লাহ',         'خالد سيف الله',
     'Md. Gias Uddin Khan',       'মোঃ গিয়াস উদ্দিন খান',    'محمد قياس الدين خان',
     '+8801726125067',
     'Kashiani, Golapganj',       'কাশিয়ানি, গোলাপগঞ্জ',     'كاشياني، جولابجانج',
     'Male', 'Mawlana', 'teachers', 'Senior Muhaddith'),


(18, 'Abu Bakar Siddiq',          'আবু বকর সিদ্দিক',          'أبو بكر الصديق',
     'Md. Ataur Rahman',          'মোঃ আতাউর রহমান',         'محمد عطا الرحمن',
     '+8801917097970',
     'Rupsha, Khulna',            'রূপসা, খুলনা',             'روبشا، خلنا',
     'Male', 'Mawlana', 'teachers', 'Senior Muhaddith'),

(19, 'Abdul Qadir',               'আabdুল কাদির',             'عبد القادر',
     'Md. Ain Uddin',             'মোঃ আইন উদ্দিন',          'محمد عين الدين',
     '+88017455508+8801',
     'Purbadhala, Netrokona',     'পূর্বধলা, নেত্রকোণা',      'بوربادالا، نتروكونا',
     'Male', 'Mawlana', 'teachers', 'Senior Muhaddith'),

(20, 'Hasibur Rahman',            'হাসিবুর রহমান',            'حسيب الرحمن',
     'Abu Raihan',                'আবু রায়হান',             'أبو ريحان',
     '+8801602267667',
     'Muttagach, Mymensingh',     'মুত্তাগাছ, ময়মনসিংহ',     'موتاجاج، ميمينسين',
     'Male', 'Mawlana', 'teachers', 'Muhaddith'),

(21, 'Abdullah bin Shafi',        'আব্দুল্লাহ বিন শফি',       'عبد الله بن شفي',
     'Md. Shafi Uddin',           'মোঃ শফি উদ্দিন',          'محمد شفي الدين',
     '+8801407854347',
     'Muttagach, Mymensingh',     'মুত্তাগাছ, ময়মনসিংহ',     'موتاجاج، ميمينسين',
...
(24, 'Mir Md. Naeem Uddin',      'মীর মো: নাঈম উদ্দিন',      'مير محمد نعيم الدين',
     'Mir Alim Uddin',            'মীর আলিম উদ্দিন',         'مير عليم الدين',
     '+8801814960404',
     'Hathazari, Chattogram',     'হাটহাজারী, চট্টগ্রাম',     'هاتهازاري، شاتٹوگرام',
     'Male', 'Mawlana', 'teachers', 'Mudarres'),

(25, 'Tareq Jamil Islam',        'তারেক জামিল ইসলাম',        'طارق جميل إسلام',
     'Tajul Islam Madani',        'তাজুল ইসলাম মাদানী',      'تاج الإسلام المدني',
     '+8801687877822',
     'Mirpur, Dhaka',             'মিরপুর, ঢাকা',             'ميربور، دكا',
     'Male', 'Mawlana', 'teachers', 'Mudarres'),
...
(27, 'Ahmad Ullah',               'আহমদ উল্লাহ',              'أحمد الله',
     'Md. Nurul Amin',            'মোঃ নুরুল আমিন',          'محمد نورالأمين',
     '+8801788544818',
     'Noakhali Sadar, Noakhali',  'নোয়াখালী সদর, নোয়াখালী','نوا؆خالي، صدار',
     'Male', 'Mawlana', 'teachers', 'Hifz Department Head'),

(28, 'Hafiz Mushab Ali Siam',    'মুছআব আলী সিয়াম',       'مشعب علي سيام',
     'Solaiman Ali',              'সোলায়মান আলী',          'سليمان علي',
     '+8801987965669',
     'Gafargaon, Mymensingh',     'গফরগাঁও, ময়মনসিংহ',     'غافرګانج، ميمينسين',
     'Male', 'Mawlana', 'teachers', 'Mudarres'),

(31, 'Muhammad Tamizuddin',      'মুহাম্মাদ তমিজুদ্দীন',    'محمد تميز الدين',
     'Foiz Uddin',                'ফয়েজ উদ্দিন',             'فويز الدين',
     '+8801995356083',
...
(33, 'Omar Faruq',               'ওমর ফারুক',               'عمر فاروق',
     'Md. Shahjahan',             'মোঃ শাহজাহান',            'محمد شاهجهان',
     '+8801641966881',
     'Karimganj, Kishoreganj',    'করিমগঞ্জ, কিশোরগঞ্জ',     'كريمانجانج، كيشرجانج',
     'Male', 'Mawlana', 'teachers', 'Mudarres'),
...
(36, 'Mujahidul Islam Zahid',    'মুজাহিদুল ইসলাম জাহিদ',   'مجاهد الإسلام زاهد',
     'Mokbul Hossain',            'মকবুল হোসেন',             'مقبول حسين',
     '+8801812303255',
     'Sreebardi, Sherpur',        'শ্রীবরদী, শেরপুর',         'شريباردي، شيربور',
     'Male', 'Mawlana', 'teachers', 'Account Keeper');