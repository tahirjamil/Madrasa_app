...
#     """Translations table for Annur database"""
#     __tablename__ = "translations"
#     __table_args__ = {"schema": "annur"}
...
#     name: Mapped[str] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False)
...
#     address: Mapped[Optional[str]] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="SET NULL", onupdate="CASCADE"), nullable=True)
...
#     father_name: Mapped[Optional[str]] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="SET NULL", onupdate="CASCADE"), nullable=True)
#     mother_name: Mapped[Optional[str]] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="SET NULL", onupdate="CASCADE"), nullable=True)
...
#     mother_translation: Mapped[Optional["Translation"]] = relationship("Translation", foreign_keys=[mother_name], back_populates="peoples_by_mother")
...
#     subject: Mapped[str] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False)
#     name: Mapped[str] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="RESTRICT", onupdate="CASCADE"), nullable=False)
#     serial: Mapped[int] = mapped_column(Integer, nullable=False)

#     # Relationships
#     subject_translation: Mapped["Translation"] = relationship("Translation", foreign_keys=[subject], back_populates="routines_by_subject")
#     name_translation: Mapped["Translation"] = relationship("Translation", foreign_keys=[name], back_populates="routines_by_name")
...
#     book: Mapped[Optional[str]] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="SET NULL", onupdate="CASCADE"), nullable=True)
...
#     # Relationships
#     book_translation: Mapped[Optional["Translation"]] = relationship("Translation", foreign_keys=[book], back_populates="exams_by_book")
...
#     title: Mapped[str] = mapped_column(String(255), ForeignKey("annur.translations.translation_text", ondelete="RESTRICT", onupdate="CASCADE"), index=True, nullable=False)
#     time: Mapped[datetime] = mapped_column(DateTime, nullable=False)
#     event_date: Mapped[date] = mapped_column(Date, nullable=False)
#     function_url: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)

#     # Relationships
#     title_translation: Mapped["Translation"] = relationship("Translation", foreign_keys=[title], back_populates="events_by_title")
